...
Feature: Supplementary Secondary Manual Acquisition Secondary Tab
  ...
  Scenario: Basic Secondary tab Testing
  	...
  	And user clicks on result with text "CQA81.2" 
  ...
  Scenario: Search to relate dialog
  	...
  	And user clicks the "Search" button
  	And user selects the record with text "CQA81.3"
  	And user selects the record with text "CQA81.4"
